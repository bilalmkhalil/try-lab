    ...
    <div className="bg-background h-screen">
      <div className="grid grid-cols-4">
        <div className="col-span-1 flex h-screen flex-col">
          <div className="border bg-primary border-border dark:border-none px-4 py-5 mt-4 flex items-center rounded-xl mx-4">
          ...
          <div className="border bg-primary border-border dark:border-none px-4 py-2 my-4 flex items-center rounded-xl mx-4">
          ...
          <motion.div className="flex flex-col gap-2 px-4 overflow-y-scroll no-scrollbar">
            {messages.map((message, index) => (
              <motion.div
                key={index}
                className="border border-border dark:border-none px-4 py-2 bg-primary  cursor-pointer rounded-xl"
